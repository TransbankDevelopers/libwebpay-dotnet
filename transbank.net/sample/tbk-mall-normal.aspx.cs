...
namespace Transbank.NET
{
    public partial class tbk_mall_normal : System.Web.UI.Page
    {
        ...
        private Dictionary<string, string> store_codes = Transbank.NET.sample.certificates.CertNormalMall.store_codes();
            ...
            switch (action)
            {
                ...
                default:
                    ...
                    try
                    {
                        ...
                        foreach (KeyValuePair<string, string> entry in store_codes)
                        {
                            /** Agregamos valores a la tienda storeCode, amount, buyOrder, sessionId */
                            stores.Add(entry.Key, new string[] {
                        ...
                        wsInitTransactionOutput result = webpay.getMallNormalTransaction().initTransaction(buyOrder, sessionId, urlReturn, urlFinal, stores);
                ...
                case "result":
                    ...
                    try
                    {
                        ...
                        transactionResultOutput result = webpay.getMallNormalTransaction().getTransactionResult(token);
